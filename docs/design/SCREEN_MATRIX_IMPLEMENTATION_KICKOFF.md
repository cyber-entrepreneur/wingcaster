...
**Created:** 2026-09-05
**Last revised:** 2026-09-08 (Rev 10 — Wave 0.5 + Backend Week 2 blockers marked RESOLVED in §5a with merge SHAs. Companion catalog: [BACKEND_BLOCKER_INDEX.md](BACKEND_BLOCKER_INDEX.md).)
...
Wave 0.5 + Backend Week 2 (WF-03) backend prerequisites that have landed. Format: **RESOLVED — merge-sha — YYYY-MM-DD — PR #N**.

| ID | Merge SHA | Date | PR |
|---|---|---|---|
| BE-BLOCKER-03 | `31169834d48ba09bdda83e0bba8282e3a40d150e` | 2026-09-08 | [#62](https://github.com/cyber-entrepreneur/wingcaster/pull/62) |
| BE-BLOCKER-05 | `0856d3c686547cb48d71cd35529f0ea71ec14f9f` | 2026-09-08 | [#58](https://github.com/cyber-entrepreneur/wingcaster/pull/58) |
| BE-BLOCKER-18 | `90d99610e20e4bbfc8d7bcdfb10994e1d02820fb` | 2026-09-08 | [#54](https://github.com/cyber-entrepreneur/wingcaster/pull/54) |
| BE-BLOCKER-20 | `a2d41939f592633873384bbff3bc1c07f00fa26b` | 2026-09-08 | [#56](https://github.com/cyber-entrepreneur/wingcaster/pull/56) |
| BE-BLOCKER-23 | `022dad411efb8a06af12a04eb468972a555ff665` | 2026-09-08 | [#55](https://github.com/cyber-entrepreneur/wingcaster/pull/55) |
| BE-BLOCKER-30 | `91f52ea364b333a6686211a25d2cfe4cc9b032fd` | 2026-09-08 | [#57](https://github.com/cyber-entrepreneur/wingcaster/pull/57) |
| BE-BLOCKER-04 | `d754aceaab5dc380f3f43432185caa615f14e6f4` | 2026-09-08 | [#59](https://github.com/cyber-entrepreneur/wingcaster/pull/59) |
| BE-BLOCKER-19 | `a4469468c52f9df026c1f186d33a29179d2e12c9` | 2026-09-08 | [#60](https://github.com/cyber-entrepreneur/wingcaster/pull/60) |
| BE-DESIGN-01 | `5a5cfad1df507c827768a3288b5d6513d9460a90` | 2026-09-08 | [#61](https://github.com/cyber-entrepreneur/wingcaster/pull/61) |
| BE-DESIGN-02 | `5fa28d242c39f6329e1f58f258f3de68b91737d4` | 2026-09-08 | [#64](https://github.com/cyber-entrepreneur/wingcaster/pull/64) |
| BE-BLOCKER-12 + 17 | `2929dfd61880f355566af409a944c98d82e12149` | 2026-09-08 | [#70](https://github.com/cyber-entrepreneur/wingcaster/pull/70) |
| BE-BLOCKER-11 | `a57d2df4aae1f6daae6b71ec6da2225a09cbc3c7` | 2026-09-08 | [#71](https://github.com/cyber-entrepreneur/wingcaster/pull/71) |
| BE-BLOCKER-01 | `2a45944a2b7ed4daf8eb4a9423611d2fe301bfed` | 2026-09-08 | [#72](https://github.com/cyber-entrepreneur/wingcaster/pull/72) |
| BE-BLOCKER-10 | `dc548b2368a3eaf048f64ab66cac334bd99b1666` | 2026-09-08 | [#73](https://github.com/cyber-entrepreneur/wingcaster/pull/73) |

**[BE-BLOCKER-01] Portal publishers stubbed.** **RESOLVED — `2a45944a2b7ed4daf8eb4a9423611d2fe301bfed` — 2026-09-08 — PR #72** (Property Finder Group adapter; other portals remain `NOT_IMPLEMENTED` stubs). `backend/src/lib/notifications/realestate.js` throws `NOT_IMPLEMENTED`. WF-03 (portal submission → moderation → outcome) cannot function end-to-end without real portal-publisher integration for the Phase-1 portal list (from `PORTAL_LIST_RESEARCH_2026-09-04.md`). Scope of the fix: implement per-portal publishers for at least the Phase-1 must-have list (Bayut, Property Finder, Dubizzle for UAE; Aqar.fm for KSA — coordinate with B3 portal list). Estimated effort: 2-3 weeks of Cursor work per portal + integration tests. **This is not a screen; it's a required backend prerequisite for Week 2 (WF-03 cluster).**
...
**[BE-BLOCKER-03] `distribution_attempts` failure-class enumeration.** **RESOLVED — `31169834d48ba09bdda83e0bba8282e3a40d150e` — 2026-09-08 — PR #62.** `007_distribution.sql:51` — `status TEXT` with no CHECK, no enum, no structured `error_class` field. AGT-PUB-003/006 cannot render 6 failure classes (auth-expired, portal-rules-violation, portal-down, quota-exceeded, invalid-content, unknown-error) without schema migration adding a CHECK-constrained `error_class` column + backend classifier + backfill. Estimated 1-2 days. **Slot: Week 2 (before AGT-PUB-003/006 dispatch).**

**[BE-BLOCKER-10] Publishing-job aggregation endpoint.** **RESOLVED — `dc548b2368a3eaf048f64ab66cac334bd99b1666` — 2026-09-08 — PR #73.** `GET /api/publishing/jobs/:id` (composes distribution_attempts + portal_registry + credit reservations for the AGT-PUB-003 receipt) + retry POST endpoints + `publishing_job.completed` push notification template do not exist today. Depends on [BE-BLOCKER-03] error_class + [BE-DESIGN-01] portal_registry landing first. Estimated 3-5 days. **Slot: Week 2 (after BE-BLOCKER-03 and BE-DESIGN-01, before AGT-PUB-003 dispatch).**
...
**[BE-BLOCKER-11] Publishing tracker endpoints.** **RESOLVED — `a57d2df4aae1f6daae6b71ec6da2225a09cbc3c7` — 2026-09-08 — PR #71.** `GET /api/publishing/tracker` (list, cursor-paginated, filterable by portal + status + listing + date range) + `GET /api/publishing/tracker/summary` (KPI aggregate for the tracker page's top strip) do not exist today. AGT-PUB-006 depends on these. Estimated 2-3 days. **Slot: Week 2 (parallel with BE-BLOCKER-10).**

**[BE-BLOCKER-12] `portal_submission.status_changed` push template.** **RESOLVED — `2929dfd61880f355566af409a944c98d82e12149` — 2026-09-08 — PR #70.** New template row with 5 status-transition variants (SUBMITTED / IN_REVIEW / LIVE / REJECTED / FAILED / EXPIRED), deep-linking to AGT-PUB-003 in retrospective mode. Piggybacks on existing WF-01/WF-03 push infrastructure. Estimated 0.5 day. **Slot: Week 2.**
...
**[BE-BLOCKER-23] `GET /api/settings/index` server-side capability-gated menu.** **RESOLVED — `022dad411efb8a06af12a04eb468972a555ff665` — 2026-09-08 — PR #55.** SHR-SET-001 uses server-only capability gating (never reads `session.role` client-side) — endpoint returns only the groups + items the caller may see. Estimated 0.5 day. **Slot: Week 4 (before SHR-SET-001 dispatch).**
...
**[BE-BLOCKER-20] `agent_onboarding_state` table + endpoints.** **RESOLVED — `a2d41939f592633873384bbff3bc1c07f00fa26b` — 2026-09-08 — PR #56.** `GET/PATCH /api/user/onboarding-state` for step/path/checklist/dismissed_forever state persistence. Required by all 5 AGT-ONB screens + AGT-DSH-001 checklist mount. Estimated 1 day. **Slot: Week 4 (must ship with AGT-ONB PR).**

**[BE-BLOCKER-19] Public token-authed scheduled-deletion endpoints + email templates + reminder cron.** **RESOLVED — `a4469468c52f9df026c1f186d33a29179d2e12c9` — 2026-09-08 — PR #60.** `GET /api/auth/scheduled-deletion/:token` + `POST /:token/cancel` (no session-cookie auth — token-signed only). Reuses existing HMAC token infra (new `purpose` enum `scheduled_deletion_view`; TTL 60 days). Three email templates via Microsoft Graph (T+0/T-7/T-1) + daily reminder cron with idempotency via `reminders_sent` on `deletion_requests`. Estimated 2-3 days. **Slot: Week 3.**
...
**[BE-BLOCKER-18] Regenerate-backup-codes endpoint.** **RESOLVED — `90d99610e20e4bbfc8d7bcdfb10994e1d02820fb` — 2026-09-08 — PR #54.** `POST /api/auth/2fa/backup-codes/regenerate` does not exist. SHR-MFA-005 requires it. Estimated 0.5 day. **Slot: Week 4 (must land with MFA screen dispatch).**
