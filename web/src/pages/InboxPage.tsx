              ...
              <div className="shrink-0 border-t border-[var(--lc-border)] bg-[var(--lc-surface)] px-5 py-3">
                <div className="flex items-end gap-2">
                  <textarea
                    ...
                    className="max-h-32 min-h-[40px] flex-1 resize-y rounded-xl border border-[var(--lc-border)] bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-transparent disabled:cursor-not-allowed disabled:opacity-50"
                  />
                  <Button
                    size="icon"
                    className="h-10 w-10 shrink-0 rounded-xl bg-[var(--lc-action-primary)] hover:bg-[var(--lc-action-primary-hover)]"
                    onClick={handleSend}
