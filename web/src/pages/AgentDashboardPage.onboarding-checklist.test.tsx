...
vi.mock('@/components/dashboard/TryProNudgeBanner', () => ({
  TryProNudgeBanner: () => null,
}))

vi.mock('@/pages/agent/dashboard/ProDashboard', () => ({
  ProDashboard: () => <div data-testid="pro-dashboard-stub" />,
}))
