...
export const api = {
  ...
  getCommandCenter: (): Promise<{
    ...
    ai_watching: Array<{
      conversation_id: string; channel: string; source?: string; contact_name: string | null;
      last_message_preview: string; last_message_at: string | null;
      ai_watch_started_at: string | null
    }>
    testimonials: Array<{
      id: string; content: string; author_name: string; source_channel: string; channel?: string;
