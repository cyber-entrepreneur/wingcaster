...
export const api = {
  ...
  // Saved searches
  getSavedSearches: () => fetchJson('/saved-searches') as Promise<SavedSearch[]>,
  ...
  runSavedSearchAlerts: () =>
    fetchJson('/saved-searches/run-alerts', { method: 'POST', body: '{}' }) as Promise<SavedSearchAlertsRunResult>,
