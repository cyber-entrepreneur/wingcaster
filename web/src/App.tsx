...
import { FullContactFormPage } from '@/pages/FullContactFormPage'
...
import { WhatsAppAuditLogPage } from '@/pages/admin/whatsapp-listings/WhatsAppAuditLogPage'
...
import {
  ApprovalsPage, ApprovalAuditTrailPage, AccountingPeriodDetailPage, AccountingPeriodsPage, AdvanceDunningStagePage, AuditPage, BillingPeriodClosePage, ConfigurationPage, ContractDetailPage, ContractsPage, CreditLotsPage,
...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      {/* AGT-APR-006 — my submitted reports (sold-price + comparables) */}
      ...
      <Route path="/contacts/new/full" element={<FullContactFormPage />} />
      ...
      <Route path="/admin/whatsapp-listings/audit" element={<WhatsAppAuditLogPage />} />
      ...
      <Route path="/admin/fin/credits/fin-mirror" element={<CreditFinMirrorPage />} />
      ...
      <Route path="/admin/fin/packages/features" element={<FeatureRegistryPage />} />
