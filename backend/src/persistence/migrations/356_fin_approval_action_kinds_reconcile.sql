-- Reconcile fin.approval_requests.action_kind CHECK after parallel Week 6 / Week 7
-- landings. 343_fin_approval_package_publish_kind dropped CAPABILITY_PACK_FINANCE_GRANT
-- that 342_capability_packs had added; restore the full union.
...
ALTER TABLE fin.approval_requests ADD CONSTRAINT chk_approval_requests_action_kind CHECK (action_kind IN (
  ...
  'PRICE_REPORT_INCORPORATE', 'PACKAGE_PUBLISH', 'CAPABILITY_PACK_FINANCE_GRANT'
));
