-- BE-BLOCKER-29 follow-up: restore CAPABILITY_PACK_FINANCE_GRANT on
-- fin.approval_requests.action_kind after 343_fin_approval_package_publish_kind
-- recreated the CHECK without it (342_capability_packs had added the value).
