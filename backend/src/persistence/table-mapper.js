...
const TABLE_MAP = {
  ...
  seller_reports: { schema: 'public', table: 'seller_reports', columns: ['property_id', 'agent_id', 'agency_id', 'state_of_play', 'agent_summary', 'show_offer_amounts', 'show_full_address', 'layout_template', 'status', 'frozen_snapshot', 'created_at', 'updated_at'] },
  ...
  access_requests: { schema: 'public', table: 'access_requests', columns: ['requester_id', 'requester_name', 'scope', 'agency_id', 'resource_type', 'resource_id', 'area_label', 'reason', 'status'] },
  platform_status_notices: { schema: 'public', table: 'platform_status_notices', columns: ['status', 'title', 'body', 'learn_more_url', 'active', 'starts_at', 'ends_at', 'created_by', 'created_at', 'updated_at'] },
