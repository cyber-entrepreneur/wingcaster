...
const TABLE_MAP = {
  ...
  publishing_jobs: {
    ...
    columns: ['property_id', 'agent_id', 'agency_id', 'submitted_at', 'completed_at'],
  },
  distributions: { schema: 'public', table: 'distribution_jobs', columns: ['property_id', 'agent_id', 'agency_id', 'publishing_job_id', 'platform', 'status', 'payload', 'scheduled_at', 'published_at', 'provider_post_id', 'error_message', 'retry_count'] },
  distribution_jobs: { schema: 'public', table: 'distribution_jobs', columns: ['property_id', 'agent_id', 'agency_id', 'publishing_job_id', 'platform', 'status', 'payload', 'scheduled_at', 'published_at', 'provider_post_id', 'error_message', 'retry_count'] },
