...
const TABLE_MAP = {
  ...
  property_offers: { schema: 'public', table: 'property_offers', columns: ['property_id', 'agent_id', 'contact_id', 'offeror_name', 'amount', 'currency', 'offer_date', 'terms', 'financing_type', 'expiry_date', 'conditions', 'status', 'notes'] },
  seller_reports: { schema: 'public', table: 'seller_reports', columns: ['property_id', 'agent_id', 'agency_id', 'state_of_play', 'agent_summary', 'show_offer_amounts', 'show_full_address', 'layout_template', 'status', 'frozen_snapshot'] },
  seller_report_share_tokens: { schema: 'public', table: 'seller_report_share_tokens', columns: ['report_id', 'token', 'recipient_email', 'revoked_at'] },
  scheduled_publications: { schema: 'public', table: 'scheduled_publications', columns: ['property_id', 'agent_id', 'agency_id', 'portals', 'message', 'scheduled_at', 'timezone', 'recurrence', 'status', 'job_id', 'attempts', 'last_error', 'last_fired_at'] },
  ...
  platform_status_notices: { schema: 'public', table: 'platform_status_notices', columns: ['status', 'title', 'body', 'learn_more_url', 'active', 'starts_at', 'ends_at', 'created_by'] },
  neighborhood_stats: { schema: 'public', table: 'neighborhood_stats', columns: ['name', 'city', 'metric', 'value'] },
  saved_searches: { schema: 'public', table: 'saved_searches', columns: ['user_id', 'agent_id', 'contact_id', 'name', 'filters', 'alert_settings', 'alert_enabled', 'alert_channel', 'alert_frequency', 'last_alert_run_at', 'last_match_count'] },
  reminder_policies: {
    schema: 'public',
  ...
  oauth_states: {
    ...
    table: 'oauth_states',
    columns: [
      'agent_id', 'agency_id', 'platform', 'code_verifier_encrypted', 'redirect_uri',
  ...
  marketplace_connections: {
    ...
    columns: [
      ...
      'credentials', 'status', 'health', 'is_primary', 'connect_method',
    ],
  },
